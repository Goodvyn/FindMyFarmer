 ...
 * @param: ArrayList<Farm> Sets up a Farm object in an array to be set up in the recycler view.
 * @param: OnItemClickListener sets up the interaction with the recycler in the Market Place.
